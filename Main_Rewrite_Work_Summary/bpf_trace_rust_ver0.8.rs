...
static BPF_DW                              : u32     = 0;
static PERF_SAMPLE_BRANCH_STACK            : u32     = 0;
static BPF_TRACE_UPROBE_MULTI              : u32     = 0;
static BPF_UPROBE_MULTI_FLAG_MASK          : u32     = 0;
static MAX_UPROBE_MULTI_CNT                : u32     = 0;
static LOOKUP_FOLLOW                       : u32     = 0;
static EBADF                               : u32     = 0;
static ESRCH                               : u32     = 0;
static BPF_UPROBE_MULTI_FLAG_PRIME         : u32     = 0;
static ARG_CONST_SIZE                      : u32     = 0;
static BPF_PROBE_WRITE_USER_PROTO          : u32     = 0;
static PERF_COUNT_SW_BPF_OUTPUT            : u32     = 0;
static BPF_EVENT_OUTPUT_NEST_LEVEL         : u32     = 0;
static EAGAIN                              : u32     = 0;
static PTR_TO_TP_BUFFER                    : u32     = 0;
static FS_KFUNC_SET_IDS                   : u32     = 0;
...
struct bpf_verifier_ops {
    get_func_proto: unsafe extern "C" fn() ,
    is_valid_access: unsafe extern "C" fn() ,
}
...
extern "C"
{
    ...
    fn try_module_get(a:i32)->i32;
    fn cant_sleep()->i32;
    fn __this_cpu_inc_return(a:i32)->i32;
    fn bpf_prog_inc_misses_counters(a:i32)->i32;
    fn rcu_dereference(a:i32)->i32;
    fn bpf_prog_run_array(a:i32,b:i32,c:i32)->i32;
    fn copy_from_user_nofault(a:i32,b:i32,c:i32)->i32;
    fn bpf_probe_read_kernel_common(a:i32,b:i32,c:i32)->i32;
    fn strncpy_from_kernel_nofault(a:i32,b:i32,c:i32)->i32;
    fn in_interrupt()->i32;
    fn nmi_uaccess_okay()->i32;
    fn copy_to_user_nofault(a:i32,b:i32,c:i32)->i32;
    ...
    fn smp_processor_id();
    fn perf_event_read_local(a:i32,b:i32,c:i32,d:i32)->i32;
    fn perf_event_output(a:i32,b:i32,c:i32);
    fn perf_sample_data_init(a:i32,b:i32)->i32;
    fn perf_sample_save_raw_data(a:i32,b:i32)->i32;
    fn preempt_disable();
    fn this_cpu_inc_return(a:i32);
    fn this_cpu_dec(a:i32);
    fn preempt_enable();
    fn perf_fetch_caller_regs(a:i32)->i32;
    fn task_pt_regs(a:i32)->u64;
    fn group_send_sig_info(a:i32,b:i32,c:i32,d:i32)->i32;
    fn put_task_struct(a:i32);
    fn irqs_disabled();
    fn valid_signal(a:i32)->i32;
    fn this_cpu_ptr(a:i32)->i32;
    fn bpf_lsm_is_sleepable_hook(a:i32)->i32;
    fn bpf_get_btf_vmlinux();
    fn btf_type_by_id(a:i32,b:i32)->i32;
    fn security_locked_down(a:i32)->i32;
    fn  bpf_prog_check_recur(a:i32)->i32;
    fn bpf_base_func_proto(a:i32)->i32;
    ...
    fn current() -> bool;
    fn bpf_prog_active() -> i32;
    fn __this_cpu_dec(a: i32);
    fn bpf_override_return();
    fn bpf_probe_read_kernel_str();
    fn bpf_probe_read_compat();
    fn bpf_seq_printf_btf();
    fn bpf_event_output_nest_level()->i32;
    fn WARN_ON_ONCE(temp: bool);
    fn container_of(a:i32,b:i32,c:i32);
    fn READ_ONCE(a:i32)->i32;
    fn task_under_cgroup_hierarchy(a:i32,b:i32)->i32;
    fn is_global_init(a:i32)->i32;
    fn get_task_struct(a:i32)->i32;
    fn kprobe_running();
    fn bpf_get_trace_printk_proto();
    fn BUILD_BUG_ON(a:i32);
    fn get_bpf_raw_tp_regs();
    fn put_bpf_raw_tp_regs();
    fn bpf_tracing_ctx_access(a:i32,b:i32 ,c:i32)->i32; 
    fn bpf_tracing_btf_ctx_access(a:i32,b:i32,c:i32,d:i32,e:i32)->i32;
    fn tracing_prog_func_proto();
    fn pe_prog_func_proto();
    fn pe_prog_is_valid_access();
    fn trace_kprobe_on_func_entry(a:i32)->i32;
    fn trace_kprobe_error_injectable(a:i32)->i32;
    fn bpf_event_rcu_dereference(a:i32)->i32;
    fn bpf_prog_array_length(a:i32)->i32;
    fn bpf_prog_array_copy(a:i32,b:i32,c:i32,d:i32,e:i32)->i32;
    fn rcu_assign_pointer(a:i32,b:i32);
    fn bpf_prog_array_free_sleepable(a:i32);
    fn bpf_prog_array_delete_safe(a:i32,b:i32)->i32;
    fn bpf_prog_put(a:i32);
    fn btf_type_snprintf_show(a:i32,b:i32,c:i32,d:i32,e:i32,f:i32)->i32;
    fn bpf_prog_array_copy_info(a:i32,b:i32,c:i32,d:i32)->i32;
    fn copy_to_user(a:i32,b:i32,c:i32)->i32;
    fn __module_address(a:i32)->i32;
    fn tracepoint_probe_register_may_exist(a:i32,b:i32,c:i32)->i32;
    fn __bpf_probe_register(a:i32,b:i32)->i32;
    fn tracepoint_probe_unregister(a:i32,b:i32,c:i32)->i32;
    fn is_syscall_trace_event(a:i32)->i32;
    fn init_irq_work(a:u32 ,b:u32);
    // fn init_irq_work()
}
...
fn bpf_get_raw_tracepoint_module(name: &str) -> Option<*mut bpf_raw_event_map> {
    ...
    for btm in bpf_module_mutex.iter() {
        ...
        for i in 0..module.num_bpf_raw_events {
            ...
            let tp_name = unsafe { (*btp.tp).name }; // 将C字符串转换为Rust字符串
...
//191-199
unsafe extern "C" fn bpf_probe_read_useri(){
    bpf_probe_read_user(0,0,0);
}
static bpf_probe_read_user_proto:bpf_func_proto = bpf_func_proto {
    func: bpf_probe_read_useri, // 假设 bpf_probe_read_user 是已经定义的 Rust 函数
    gpl_only: true,
    ret_type: RET_INTEGER,
...
unsafe extern "C" fn bpf_probe_read_user_stri(){
    bpf_probe_read_user_str(NonNull::dangling(),0,NonNull::dangling());

}
static bpf_probe_read_user_str_proto : bpf_func_proto = bpf_func_proto {
    func: bpf_probe_read_user_stri, // 假设 bpf_probe_read_user 是已经定义的 Rust 函数
    gpl_only: true,
    ret_type: RET_INTEGER,
    arg1_type: ARG_PTR_TO_UNINIT_MEM,
    arg2_type: ARG_CONST_SIZE_OR_ZERO,
...
unsafe extern "C" fn bpf_probe_read_kerneli(){
    bpf_probe_read_kernel(NonNull::dangling(),0,NonNull::dangling());
}
static bpf_probe_read_kernel_proto:bpf_func_proto = bpf_func_proto {
    func: bpf_probe_read_kerneli, // 假设 bpf_probe_read_user 是已经定义的 Rust 函数
    gpl_only: true,
    ret_type: RET_INTEGER,
    arg1_type: ARG_PTR_TO_UNINIT_MEM,
    arg2_type: ARG_CONST_SIZE_OR_ZERO,
...
unsafe extern "C" fn bpf_probe_read_compat_stri(){
    bpf_probe_read_compat_str(0,0,0);
}
static bpf_probe_read_compat_str_proto: bpf_func_proto=bpf_func_proto
{
    func:bpf_probe_read_compat_stri,
    gpl_only:true,
    ret_type:RET_INTEGER,
    arg1_type:ARG_PTR_TO_UNINIT_MEM,
    arg2_type:ARG_CONST_SIZE_OR_ZERO,
...
unsafe extern "C" fn bpf_probe_write_useri(){
    bpf_probe_write_user(0,0,0);
}
static bpf_probe_write_user_proto:bpf_func_proto = bpf_func_proto {
    func: bpf_probe_write_useri, // 假设 bpf_probe_read_user 是已经定义的 Rust 函数
    gpl_only: true,
    ret_type: RET_INTEGER,
...
unsafe fn bpf_get_probe_write_proto() -> Option<&'static bpf_func_proto> {
...
//     gpl_only: true,
//     ret_type: Integer,
//     arg1_type:PtrToMemReadOnly,
//     arg2_type:ConstSize,
//     arg3_type:PtrToMemMaybeNullReadOnly,
//     arg4_type:ConstSizeOrZero,
//     arg5_type: 0,
// };
...
unsafe extern "C" fn bpf_trace_vprintki(){
    bpf_trace_vprintk(0,0,0,0);
}
// BPF函数实现
static BPF_TRACE_VPRINTK_PROTO: bpf_func_proto = bpf_func_proto {
    func: bpf_trace_vprintki,
    gpl_only: true,
    ret_type: KSYM_NAME_LEN,
    arg1_type: ENOSPC,
    arg2_type: BPF_TRACE_KPROBE_MULTI   ,
    arg3_type: BPF_F_KPROBE_MULTI_RETURN,
    arg4_type: MAX_KPROBE_MULTI_CNT     ,
...
// 获取BPF函数原型
unsafe fn bpf_get_trace_vprintk_proto() -> &'static bpf_func_proto {
...
unsafe extern "C" fn bpf_perf_event_read_valuei(){
    bpf_perf_event_read_value(0,0,0,0);

}
// 示例函数原型定义
static bpf_perf_event_read_value_proto:bpf_func_proto = bpf_func_proto {
    func: bpf_perf_event_read_valuei, // 假设这个函数已经定义
    gpl_only: true,
    ret_type: BPF_FD_TYPE_TRACEPOINT  ,
    arg1_type:CONFIG_KPROBE_EVENTS    ,
    arg2_type:TRACE_EVENT_FL_UPROBE   ,
    arg3_type:MODULE_STATE_COMING     ,
    arg4_type:MODULE_STATE_GOING      ,
...
//         // 假设的输出函数
//         __bpf_perf_event_output(regs, map, flags, &sd) as Result<u32,u32>
//     });
...
//     err
// }
// unsafe extern "C" fn bpf_perf_event_outputi(){
//     bpf_perf_event_output(0,0,0,0,0);
// } 
// static  bpf_perf_event_output_proto:bpf_func_proto = bpf_func_proto {
//     func: bpf_perf_event_outputi, // 假设 bpf_probe_read_user 是已经定义的 Rust 函数
//     gpl_only: true,
//     ret_type: RET_INTEGER,
//     arg1_type:ARG_PTR_TO_CTX,
...
static BPF_MISC_SDS:  bpf_link_primer_opsi= bpf_link_primer_opsi{
    sds: [0,0,0,0,0],
    regs: [0,0,0,0,0],
};
static BPF_PT_REGS:  bpf_link_primer_opsi= bpf_link_primer_opsi{
    sds: [0,0,0,0,0],
    regs: [0,0,0,0,0],
};
//718-759
...
//777-829
unsafe extern "C" fn bpf_get_current_task_btfi(){
    bpf_get_current_task_btf();
}
static bpf_get_current_task_btf_proto:bpf_func_proto = bpf_func_proto {
    func: bpf_get_current_task_btfi,
    gpl_only: true,
...
unsafe fn bpf_task_pt_regs(task : NonNull<task_struct>)-> u64{
    let ret = task_pt_regs(task) as u64;
    ret
}
unsafe extern "C" fn bpf_task_pt_regsi(){
    bpf_task_pt_regs(0);
}
static bpf_task_pt_regs_proto:bpf_func_proto  = bpf_func_proto {
    func: bpf_task_pt_regsi,
    gpl_only: true,
...
fn bpf_current_task_under_cgroup(map: NonNull<bpf_map>,idx: u32) -> i64 {
    unsafe{
        let array: NonNull<bpf_array> = container_of(map.as_ptr(), map, map.as_ptr());
...
unsafe extern "C" fn bpf_current_task_under_cgroupi(){
    bpf_current_task_under_cgroup(0,0);
}
static  bpf_current_task_under_cgroup_proto:bpf_func_proto  = bpf_func_proto{
	func           : bpf_current_task_under_cgroupi,
	gpl_only       : false,
	ret_type       : RET_INTEGER,
...
{
    let work = container_of(entry, entry, entry);
    group_send_sig_info(work.sig, SEND_SIG_PRIV, work.task, work.typee);
    put_task_struct(work.task);
}
//843-883
static CURRENT : current1 = current1{
    flags: 0,
};
unsafe fn bpf_send_signal_common(sig: u32, type_: u32) -> i32 {
    let work: Option<&mut send_signal_irq_work>;
...
unsafe fn bpf_send_signal_thread(sig : u32)-> i32{
    return bpf_send_signal_common(sig, PIDTYPE_PID);
}
unsafe extern "C" fn bpf_send_signal_threadi(){
    bpf_send_signal_thread(0);
}
static  bpf_send_signal_thread_proto:bpf_func_proto = bpf_func_proto{
	func		: bpf_send_signal_threadi,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_ANYTHING,
...
// 允许列表的静态初始化
static BTF_ALLOWLIST_D_PATH: btf_id_set = btf_id_set{
    id: 0,
};
...
unsafe fn bpf_snprintf_btf(str: *mut c_char, str_size: u32, ptr: *const BtfPtr, btf_ptr_size: u32, flags: u64) -> i32 {
    ...
    match bpf_btf_printf_prepare(&*ptr, btf_ptr_size, flags) {
        Ok((btf, btf_id)) => {
            ...
            btf_type_snprintf_show(btf, btf_id, (*ptr).ptr, str_slice,str_slice , flags)
        },
...
unsafe extern "C" fn bpf_get_func_ip_tracingi(){
    bpf_get_func_ip_tracing(0);
...
static  bpf_get_func_ip_proto_tracing:bpf_func_proto = bpf_func_proto {
    ...
    // 实际使用时，应该替换为正确的函数指针
    func: bpf_get_func_ip_tracingi, // 假设的函数指针
    gpl_only: false ,
    ret_type: MODULE_STATE_COMING,
    arg1_type: __GFP_NOWARN,
...
fn bpf_get_func_ip_kprobe(regs:NonNull<pt_regs>)-> i32 {
    unsafe{
        if cfg!(feature = "CONFIG_UPROBES") {
            let mut run_ctx : NonNull<bpf_trace_run_ctx>=container_of(current.bpf_ctx, current.bpf_ctx, current.bpf_ctx);
            ...
            return get_entry_ip(kp.addr as u32);
        }  
    }
}
unsafe extern "C" fn bpf_get_func_ip_kprobei(){
    bpf_get_func_ip_kprobe(0);
}
static  bpf_get_func_ip_proto_kprobe : bpf_func_proto = bpf_func_proto{
	func		: bpf_get_func_ip_kprobei,
	gpl_only	: true,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
unsafe extern "C" fn bpf_get_func_ip_kprobe_multii(){
    bpf_get_func_ip_kprobe_multi(0);
}
static  bpf_get_attach_cookie_proto_kmulti : bpf_func_proto = bpf_func_proto{
	func		: bpf_get_func_ip_kprobe_multii,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
unsafe extern "C" fn bpf_get_func_ip_uprobe_multii(){
    bpf_get_func_ip_uprobe_multi(0);
}
static  bpf_get_func_ip_proto_uprobe_multi : bpf_func_proto = bpf_func_proto{
	func		: bpf_get_func_ip_uprobe_multii,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
unsafe extern "C" fn bpf_get_attach_cookie_uprobe_multii(){
    bpf_get_attach_cookie_uprobe_multi(0);
}
static  bpf_get_attach_cookie_proto_umulti : bpf_func_proto = bpf_func_proto{
	func		: bpf_get_attach_cookie_uprobe_multii,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
fn bpf_get_attach_cookie_trace(ctx : NonNull<c_void>)-> i32{
    unsafe{
        let run_ctx : NonNull<bpf_trace_run_ctx> = container_of(current.bpf_ctx,  current.bpf_ctx, current.bpf_ctx);
        return *(run_ctx.as_ptr()).cookie;
    }
}
unsafe extern "C" fn bpf_get_attach_cookie_tracei(){
    bpf_get_attach_cookie_trace(0);
}
static  bpf_get_attach_cookie_proto_trace:bpf_func_proto = bpf_func_proto{
	func		: bpf_get_attach_cookie_tracei,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
unsafe extern "C" fn bpf_get_attach_cookie_pei(){
    bpf_get_attach_cookie_pe(0);
}
static  bpf_get_attach_cookie_proto_pe:bpf_func_proto = bpf_func_proto{
	func		: bpf_get_attach_cookie_pei,
	gpl_only	: false,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
...
unsafe extern "C" fn get_func_argi(){
    get_func_arg(0,0,0);
}
...
// 定义get_func_arg_cnt函数fn get_func_arg_cnt(ctx: *mut std::ffi::c_void) -> u64 {
//     unsafe {
//         // 将ctx转换为指向u64的指针，并偏移-1
//         *((ctx as *mut u64).offset(-1))
//     }
...
// 实例化BpfFuncProto
unsafe extern "C" fn get_func_arg_cnti(){
    get_func_arg_cnt(0);
}
static BPF_GET_FUNC_ARG_CNT_PROTO: bpf_func_proto = bpf_func_proto {
    func: get_func_arg_cnti,
    ret_type: MAX_UPROBE_MULTI_CNT,
    arg1_type: MAX_UPROBE_MULTI_CNT,
    arg2_type: 0,
    arg3_type: 0,
    arg4_type: 0,
    arg5_type: 0,
...
unsafe fn bpf_tracing_func_proto(func_id: bpf_func_id, prog: &bpf_prog) -> Option<&'static bpf_func_proto> {
    match func_id {
...
// unsafe fn kprobe_prog_func_proto(func_id: bpf_func_id, prog: &bpf_prog) -> Option<&'static bpf_func_proto> {
//     match func_id {
...
unsafe fn bpf_perf_event_output_tp(tp_buff: *mut c_void, map: *mut bpf_map, flags: u64, data: *mut c_void, size: u64) -> i32 {
...
// 1720-1732
unsafe fn bpf_get_stackid_tp(tp_buff: *mut c_void, map: *mut bpf_map, flags: u64) -> i32 {
...
fn tp_prog_func_proto(func_id: BpfFuncId, prog: &BpfProg) -> &'static bpf_func_proto {
    match func_id {
...
pub unsafe fn tp_prog_is_valid_access(off: i32, size: i32, type_: bpf_access_type, 
...
// 1793-1801 TODO:
// 定义函数指针类型
type GetFuncProto = fn(BpfFuncId, &BpfProg) -> &'static bpf_func_proto;
...
unsafe extern "C" fn bpf_read_branch_recordsi(){
    bpf_read_branch_records(0,0,0,0);
}
// 1856-1886
// 定义 bpf_read_branch_records_proto 常量
const BPF_READ_BRANCH_RECORDS_PROTO: bpf_func_proto = bpf_func_proto {
    func: bpf_read_branch_recordsi,
    gpl_only: true,
    ret_type: RET_INTEGER,
    arg1_type: ARG_PTR_TO_CTX,
...
fn bpf_perf_event_output_raw_tp(args:NonNull<bpf_raw_tracepoint_args>,map:NonNull<bpf_map>,flags:u64,data:NonNull<c_void>,size:u64)->i32{
    unsafe{
        ...
        perf_fetch_caller_regs(regs);
        let mut ret =____bpf_perf_event_output(regs, map, flags, data, size);
        put_bpf_raw_tp_regs();
        ret
    }
}
unsafe extern "C" fn bpf_perf_event_output_raw_tpi(){
    bpf_perf_event_output_raw_tp(0,0,0,0,0);
}

// TODO:
static  bpf_perf_event_output_proto_raw_tp: bpf_func_proto = bpf_func_proto{
	func		: bpf_perf_event_output_raw_tpi,
	gpl_only	: true,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
	arg2_type	: ARG_CONST_MAP_PTR,
...
fn bpf_get_stackid_raw_tp(args:NonNull<bpf_raw_tracepoint_args>,map:NonNull<bpf_map>,flags:u64){
    unsafe{
        ...
        perf_fetch_caller_regs(regs);
        let mut ret = bpf_get_stackid( regs as u64,  map as u64,flags, 0, 0);
        put_bpf_raw_tp_regs();
        ret
    }
}
// TODO:
unsafe extern "C" fn bpf_get_stackid_raw_tpi(){
    bpf_get_stackid_raw_tp(0,0,0);
}
static  bpf_get_stackid_proto_raw_tp: bpf_func_proto = bpf_func_proto{
	func		: bpf_get_stackid_raw_tpi,
	gpl_only	: true,
	ret_type	: RET_INTEGER,
	arg1_type	: ARG_PTR_TO_CTX,
	arg2_type	: ARG_CONST_MAP_PTR,
...
fn bpf_get_stack_raw_tp(args : NonNull<bpf_raw_tracepoint_args>,buf:NonNull<c_void>,size:u32,flags:u64){
    unsafe{
        ...
        perf_fetch_caller_regs(regs);
        let mut ret = bpf_get_stack( regs as u64,  buf as u64, size, flags,0);
        put_bpf_raw_tp_regs();
        ret
    }
}
...
unsafe extern "C" fn bpf_get_stack_raw_tpi(){
    bpf_get_stack_raw_tp(0,0,0,0);
}
const BPF_GET_STACK_PROTO_RAW_TP: bpf_func_proto = bpf_func_proto {
    func: bpf_get_stack_raw_tpi,
    gpl_only: true,
    ret_type: RET_INTEGER,
    arg1_type: ARG_PTR_TO_CTX,
    arg2_type: ARG_PTR_TO_MEM | MEM_RDONLY,
...
// unsafe fn tracing_prog_func_proto(func_id: bpf_func_id, prog: *mut bpf_prog )-> *mut bpf_func_proto
// {
//     let fnn: *mut bpf_func_proto;
//     match (func_id)
//     {
...
unsafe fn raw_tp_prog_is_valid_access(
    off: i32,
    size: i32,
    access_type: bpf_access_type,
    prog: &bpf_prog,
...
unsafe fn tracing_prog_is_valid_access(
    off: i32,
    size: i32,
    access_type: bpf_access_type,
    prog: &bpf_prog,
...
unsafe extern "C" fn raw_tp_prog_func_protoi(){
    raw_tp_prog_func_proto(0,0);
}
unsafe extern "C" fn raw_tp_prog_is_valid_accessi(){
    raw_tp_prog_is_valid_access(0,0,0,0,0);
}
// 实例化`bpf_verifier_ops`和`bpf_prog_ops`结构体
static RAW_TRACEPOINT_VERIFIER_OPS: bpf_verifier_ops = bpf_verifier_ops {
    get_func_proto: raw_tp_prog_func_protoi,
    is_valid_access: raw_tp_prog_is_valid_accessi,
};
...
unsafe extern "C" fn tracing_prog_is_valid_accessi(){
    tracing_prog_is_valid_access(0,0,0,0,0);
}
static TRACING_VERIFIER_OPS: bpf_verifier_ops = bpf_verifier_ops {
    get_func_proto: tracing_prog_func_proto,
    is_valid_access: tracing_prog_is_valid_accessi,
};
...
unsafe fn raw_tp_writable_prog_is_valid_access(
    off: i32,
    size: i32,
    access_type: bpf_access_type,
    prog: &bpf_prog,
...
unsafe fn perf_event_attach_bpf_prog(
...
unsafe fn perf_event_detach_bpf_prog(event: &mut perf_event) {
    // 获取 bpf_event_mutex 的锁
...
// unsafe fn __bpf_probe_register(btp: *mut bpf_raw_event_map, prog: *mut bpf_prog) -> i32
// {
//     let tp: *mut tracepoint = btp.tp;
//     if(prog.aux.max_ctx_offset > btp())
//     {
//         return -EINVAL;
//     }
...
unsafe fn bpf_probe_register(btp: *mut bpf_raw_event_map, prog: *mut bpf_prog) -> i32
{
    return __bpf_probe_register(btp, prog);
}

unsafe fn bpf_probe_unregister(btp: *mut bpf_raw_event_map, prog: *mut bpf_prog) -> i32
{
    return tracepoint_probe_unregister(btp.tp, btp.bpf_func as *mut c_void, prog);
}

unsafe fn bpf_get_perf_event_info(event: *const perf_event, prog_id: *mut u32, fd_type: *mut u32, buf: *mut *const c_char, probe_offset: *mut u64, probe_addr: *mut u64, missed: *mut c_ulong) -> i32
{
...
unsafe fn bpf_uprobe_multi_link_release(link: *mut bpf_link)
{
...
// 3159-3227
unsafe fn bpf_uprobe_multi_link_fill_link_info(link: &bpf_link, info: &mut bpf_link_info) -> Result<(), i32> {
